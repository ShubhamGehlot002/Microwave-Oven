...
void main(void) {
    ...
    while(1) {
        ...
        if(operation_mode == 0x02 || operation_mode == 0x03 || operation_mode == 0x04)
        {
            ;
        }
        else if(key == 1)
...
void set_time(unsigned char key)
{
    ...
    if(wait++ == 50)
    {
        wait = 0;
        blink = !blink;
        clcd_print(min_array,(0xC0 + 6));
        clcd_print(sec_array,(0xC0 + 9));
    }
    if(blink)
    {
        switch(blink_pos)
...
char door_status_check(void)
{
    if(RB3 == 0)
    {
        ...
        TMR2ON = 0;
        clear_display();
        clcd_print("Door Status:OPEN", (0xC0 + 0));
        clcd_print("  Please Close", (0x90 + 0));
        while(RB3 == 0)
        {
            ;
        }
...
void time_display(void)
{
    ...
    min_array[1] = min % 10 + '0';
    min_array[2] = '\0';
    clcd_print(min_array, (0x80 + 9));
    clcd_putch(':', (0x80 + 11));


    clcd_putch(sec / 100 + '0',(0x80 + 12));
    clcd_putch((sec / 10)%10 + '0',(0x80 + 13));
    ...
    if((min == 0) && (sec == 0))
    {
        ...
        RC2 = 0;
        clear_display();
        clcd_print("Cooking Time UP", (0xC0 + 0));
        RC1 = 1;
        _delay((unsigned long)((3000)*(20000000/4000.0)));
        RC1 = 0;
...
char set_temp(unsigned char key)
{
    ...
    if(reset_flag == 0X14)
    {
        ...
        temp = 0;
        wait = 0;
        clcd_print("SET TEMP. (  ", (0x80 + 0));
        clcd_putch(0xDF, (0x80 + 12));
        clcd_print("C )", (0x80 + 13));
        clcd_print(" TEMP : 000", (0xC0 + 0));
        clcd_print("*:CLEAR  #:ENTER", (0xD0 + 0));
    ...
    else if (key == '#')
    {
       ...
       if(temp > 250)
       {
           clcd_print(" Invalid Temp.", (0xC0 + 0));
            RC1 = 1;
       ...
       else
       {
           ...
           while(sec)
           {
               RB3 = door_status_check();
               if(RB3 == 1)
               {
                  clcd_print("  Pre-Heating", (0x80 + 0));
                  clcd_print("Time Rem.=", (0x90 + 0));
               }
               clcd_putch((sec / 100 + '0'), (0x90 + 10));
               clcd_putch((sec/10) % 10 + '0', (0x90 + 11));
               clcd_putch(sec%10 + '0', (0x90 + 12));
           }
           return 0;
       }
     ...
     if(wait++ == 25)
    {
        wait = 0;
        blink = !blink;
        clcd_putch((temp / 100 + '0'), (0xC0 + 8));
        clcd_putch((temp/10) % 10 + '0', (0xC0 + 9));
        clcd_putch(temp%10 + '0', (0xC0 + 10));
